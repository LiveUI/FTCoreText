Pod::Spec.new do |s|
  ...
  s.name         = "FTCoreText"
  s.version      = "1.0.1"
  s.summary      = "UIView subclass for rendering static content with CoreText using a Swift interface and highly customisable markup syntax."
  ...
  s.source_files  = 'Sources/FTCoreText/**/*.swift'
